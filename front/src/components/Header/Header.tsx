...
const Header = () => {
  ...
  return (
    <div className="min-w-[1366px] h-[72px] border-b border-gray border-opacity-70 flex flex-row justify-start items-center">
      <img
        src={logo}
        alt="logo"
      ...
      <div className="flex flex-row items-center justify-center ml-[58vw] flex-1 h-full">
        <HeaderButton isClicked={path === "/" ? true : false} name="메인" />
        <HeaderButton
